...
syslog(LOG_LOCAL3|LOG_NOTICE, "INFO:%s(%d):%s: %s",__FILE__,__LINE__,__func__, __buf__); }

#define LogWarn(fmt, ...) {\
char __buf__[2048];snprintf(__buf__,sizeof(__buf__)-1, fmt, ##__VA_ARGS__);\
syslog(LOG_LOCAL3|LOG_NOTICE, "WARNING:%s(%d):%s: %s",__FILE__,__LINE__,__func__, __buf__); }

#define LogError(fmt, ...) {\
char __buf__[2048];snprintf(__buf__,sizeof(__buf__)-1, fmt, ##__VA_ARGS__);\
syslog(LOG_LOCAL3|LOG_NOTICE, "ERROR:%s(%d):%s: %s",__FILE__,__LINE__,__func__, __buf__); }

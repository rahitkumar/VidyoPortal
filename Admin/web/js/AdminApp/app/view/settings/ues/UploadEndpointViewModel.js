/**
 * @class UploadEndpointViewModel
 */
Ext.define('AdminApp.view.settings.ues.UploadEndpointViewModel', {
    extend : 'Ext.app.ViewModel',
    alias : 'viewmodel.UploadEndpointViewModel',

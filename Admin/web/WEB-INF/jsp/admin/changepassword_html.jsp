        ...
        Ext.onReady(function() {
            ...
            Ext.application({
                ...
                launch : function() {
                    ...
                    var adminChangePasswordForm = Ext.define('changePasswordPanel', {
                        ...
                        initComponent : function() {
                            ...
                            Ext.apply(Ext.form.VTypes, {
                                password : function(val, field) {
                                    if (field.initialPassField) {
                                        ...
                                        if (pwd.getValue() != '') {
                                            if (val == pwd.getValue()) {
                                                pwd.clearInvalid();
                                                adminChangePasswordForm.down('button').enable();
                                                return true;
                                            } else {
                                                adminChangePasswordForm.down('button').disable();
                                                return false;
                                            }
                                        }
                                        return true;
                                ...
                                password1Text : 'Passwords do not match'
                            ...
                            this.items = [{
                                ...
                                name : 'password1',
                                reference : 'password1',
                                fieldLabel : '<span class="red-label">New Password For The User</span>',
                                inputType : 'password',
                                allowBlank : false,
                                tabIndex : 4,
                                width : 400,
                                ...
                                name : 'password2',
                                reference : 'password2',
                                fieldLabel : '<span class="red-label">Verify New Password</span>',
                                inputType : 'password',
                                allowBlank : false,
                                width : 400,
                                labelWidth : 180,
                                ...
                                listeners : {
                                    keypress : function(textfield, eo) {
                                        if (!adminChangePasswordForm.getForm().isValid()) {
                                            return;
                                        }
                                        if (eo.getCharCode() == Ext.EventObject.ENTER) {
                                            Ext.Ajax.request({
                                                ...
                                                waitMsg : 'Saving',
                                                params : adminChangePasswordForm.getForm().getValues(),
                                                method : 'POST',
                                                ...
                                                failure : function(form, action) {
                                                    Ext.Msg.alert("Failure", "Save failed");
                                                }
                                            });
                                        }
                                    }
                    ...
                    adminChangePasswordForm = Ext.create('changePasswordPanel');

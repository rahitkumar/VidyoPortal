...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<%= html_lang%>" lang="<%= html_lang%>">
    ...
    <body class='bodyCls'>
     ...
     <script>
            ...
            blnShowForgotPassword = '<c:out value="${model.showForgotPassword}"/>';
            ...
            var loginBanner = '<c:out value="${model.loginBanner}" escapeXml="false"/>';
                ...
                Ext.onReady(function() {
                    ...
                    Ext.application({
                        ...
                        launch : function() {
                            ...
                            if (!adminLoginForm) {
                                var adminLoginForm = Ext.create('Ext.panel.Panel', {
                                    width : 400,
                                    frame:true,
                                    margin : '0 0 40 500',
                                    closable : false,
                                    ...
                                    tools : [{
                                        ...
                                        handler : function(event, toolEl, panel) {
                                            var url = '<c:out value="${model.guideLoc}"/>#Admin_Login';
                                    ...
                                    items : [{
                                        ...
                                        items : [{
                                            ...
                                            listeners : {
                                                afterrender : function(username) {
                                                    if (showLoginBanner == "false")
                                                        username.focus(true, 10);
                                                }
                                            }
                                        }, {
                                                    ...
                                                    if (eo.getCharCode() == Ext.EventObject.ENTER) {
                                                        ...
                                                        if (form.isValid()) {
                                                            ...
                                                            if (sessionLang != '' && sessionLang == 'on') {
                                                                loginUrl = "admin_security_check?session_lang=on";
                                                            } else {
                                                                loginUrl = "admin_security_check";
                                                            }
                                                            var form = this.up('form').getForm();
                                                            form.url = loginUrl;
                                                                                        ...
                                                                                        success : function(form, action) {
                                                                                            ...
                                                                                            if (success == "false") {
                                                                                                ...
                                                                                                Ext.Msg.alert(l10n('password-sent'), l10n('please-check-your-e-mail-account-for-instructions-on-completing-the-password-reset-process'), function() {
                                                                                                    form.down('textfield[name=email]').reset();
                                                                                                    forgotwin.hide();
                                                                                                });
                                                                                            }
                                                                                        },

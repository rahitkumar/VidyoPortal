...
<response portalVersion="<c:out value="${model.portalVersion}"/>">
	<myRoom>
		...
		<roomMode>
			...
			<roomPIN><c:out value="${model.myroom.roomPIN}"/></roomPIN>
	...
	<contacts total="<c:out value="${model.num_contacts}"/>">
		<c:forEach items="${model.list_contacts}" var="entity">
			<contact>
				...
				<roomMode>
					...
					<roomPIN><c:out value="${entity.roomPIN}"/></roomPIN>
	...
	<entities total="<c:out value="${model.num_search}"/>">
		<c:forEach items="${model.list_search}" var="entity">
			<entity>
				<entityID><c:out value="${entity.roomID}"/></entityID>
				<displayName><c:out value="${entity.name}"/></displayName>
				<extension><c:out value="${entity.ext}"/></extension>

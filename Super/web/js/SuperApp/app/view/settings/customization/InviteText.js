Ext.define('SuperApp.view.settings.customization.InviteText', {
            ...
            insertAtCursor : function(v) {
                ...
                me.items = [{
                    ...
                    tools : [{
                        ...
                        tooltip : '<b>' + l10n('insert-room-link') + '</b><br/>' + l10n("optional"),
                        listeners : {
                            click : function(v) {
                    ...
                    tools : [{
                        ...
                        disabled : true,
                        tooltip : '<b>' + l10n('insert-dial-string') + '</b><br/>' + l10n('restart'),
                        listeners : {
                            click : function(v) {
                    ...
                    tools : [{
                        ...
                        tooltip : '<b>' + l10n('insert-webcast-url') + '</b><br/>' + l10n('restart'),
                        listeners : {
                            click : function(v) {

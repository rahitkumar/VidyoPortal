...
@ContextConfiguration(
		{
			"file:web/WEB-INF/super-service-context.xml",
			"file:web/WEB-INF/vidyo-portal-super-rest-servlet.xml",
			"file:web/WEB-INF/super-service-interceptors.xml",
			"file:web/WEB-INF/super-service-security.xml"
		}		
)
@Ignore
public class SuperServiceCtxTest {

	@Autowired
	private ApplicationContext applicationContext;
	
	public SuperServiceCtxTest() throws Exception {
		setup();
	}

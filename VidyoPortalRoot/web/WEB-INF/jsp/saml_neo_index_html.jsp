 ...
 <div id="neocontainer" style="text-align: center; padding: 50px; font-size: 14px; max-width: 910px; min-width: 910px; width: 910px; margin: auto;">
    ...
    <div style="text-align: center; color: #5d5d5d;">
        <div id="downloadContainer" style="background-color: #f6f6f6; margin: 0px 0px 30px 0px;">
            ...
            <c:if test="${not empty model.neoWebRTCUrl}">
	            <div style="padding: 0px 0px 20px 0px; font-weight: 400; font-size: 14px; color: #5d5d5d; ">
	                <spring:message code="having.trouble.with.the.desktop.app.you.can" htmlEscape="true"/> <a href="<c:out value="${model.neoWebRTCUrl}"/>" style="color: #5d5d5d;" ><spring:message code="join.via.your.browser.instead" htmlEscape="true"/></a>.
	            </div>
	        </c:if>
        </div>
		...
		<div id="downloadContainerLegal"
			...
			<a target="_blank" style="color: #6a6a6a;" href="/terms_content.html"><spring:message
				...
				href="<c:url value="${model.privacyUrl}"></c:url>"><spring:message

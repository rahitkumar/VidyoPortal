            ...
            <div id="runVDTable" class="downloadTable">
                <div id="runVDTableRow" class="downloadTableRow">
                    <div class="downloadTableRowImgCell">
                        <div id="downloadMacTableStep1"></div>
                    </div>
                    <div class="downloadTableRowImgCell">
                        <div id="downloadMacTableStep2"></div>
                    </div>
                    <div class="downloadTableRowImgCell">
                        <div id="downloadMacTableStep3"></div>
                    </div>
                </div>
                <div id="runVDTableRow" class="downloadTableRow">
                    <div class="downloadTableRowCell1">
                        1. <spring:message htmlEscape="true" code="open.the.downloaded.file"/>
                    </div>
                    <div class="downloadTableRowCell1">
                ...
                <div id="runVDTableRow" class="downloadTableRow">
                    <div class="downloadTableRowCell2">
                        <spring:message htmlEscape="true" code="open.the.dmg.file.from.the.browser.s.downloads.folder"/>
                    </div>
                    <div class="downloadTableRowCell2">
                        <spring:message htmlEscape="false" code="double.click.the.vidyodesktoptrade.installer"/>
                    </div>
                    <div class="downloadTableRowCell2">
                        <spring:message htmlEscape="true" code="log.in.or.click.on.a.vidyo.link.to.start.a.conference"/>
                    </div>
                </div>
            </div>
        </div>

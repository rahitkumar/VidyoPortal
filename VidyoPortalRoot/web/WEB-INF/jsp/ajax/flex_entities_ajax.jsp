...
<response portalVersion="<c:out value="${model.portalVersion}"/>">
    ...
    <c:if test="${not empty model.control}">
        ...
        <c:if test="${model.myroom.allowWebcasting != '0'}">
            <canWebcastMeeting>true</canWebcastMeeting>
        </c:if>
        <c:if test="${model.myroom.allowWebcasting == '0'}">
            <canWebcastMeeting>false</canWebcastMeeting>
        </c:if>
    ...
    <entities total="<c:out value="${model.num}"/>">
        <c:forEach items="${model.list}" var="entity">
            <entity>
                ...
                <c:if test="${entity.allowWebcasting != '0'}">
                    <canWebcastMeeting>true</canWebcastMeeting>
                </c:if>
                <c:if test="${entity.allowWebcasting == '0'}">
                    <canWebcastMeeting>false</canWebcastMeeting>

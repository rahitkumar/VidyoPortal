 ...
 * @param {Object} config
 */
Ext.form.DateFieldFix = Ext.extend(Ext.form.TriggerField,  {
    /**
     * @cfg {String} format
    ...
    initComponent : function(){
        Ext.form.DateFieldFix.superclass.initComponent.call(this);

        this.addEvents(
            /**
             * @event select
             * Fires when a date is selected via the date picker.
             * @param {Ext.form.DateFieldFix} this
    ...
    validateValue : function(value){
        ...
        if(!Ext.form.DateFieldFix.superclass.validateValue.call(this, value)){
            this.markInvalid(String.format(this.invalidText, value, this.format));
            return false;
        }
     ...
     */
    getValue : function(){
        return this.parseDate(Ext.form.DateFieldFix.superclass.getValue.call(this)) || "";
    },
...
dateField.setValue('2006-05-04');
    ...
    setValue : function(date){
        Ext.form.DateFieldFix.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    },
    ...
    onDestroy : function(){
        ...
        Ext.form.DateFieldFix.superclass.onDestroy.call(this);
    },
...
Ext.reg('datefieldfix', Ext.form.DateFieldFix);
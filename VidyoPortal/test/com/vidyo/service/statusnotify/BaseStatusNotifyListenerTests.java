 ...
 *
 */
public class BaseStatusNotifyListenerTests {

	@InjectMocks
	private BaseStatusNotifyListener baseStatusNotifyListener;
	...
	public void testCallExternalRestServiceWithInvalidUserId() {
		...
		baseStatusNotifyListener.setRetryTemplate(retryTemplate());
		...
		Exception e = null;
		try {
			retryResult = baseStatusNotifyListener.callExternalRestService(notificationInfo);
		} catch (Exception rce) {
		...
		Assert.assertEquals(e.getMessage(), "Non HTTP 200 Status: 400 Bad Request");

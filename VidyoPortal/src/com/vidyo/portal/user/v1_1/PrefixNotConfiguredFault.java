 ...
 */
            ...
            /**
            *  PrefixNotConfiguredFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PrefixNotConfiguredFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/user/v1_1",
                "PrefixNotConfiguredFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PrefixNotConfiguredFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PrefixNotConfiguredFault",
    ...
    public static class Factory{
        ...
        */
        public static PrefixNotConfiguredFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PrefixNotConfiguredFault object =
                new PrefixNotConfiguredFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PrefixNotConfiguredFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PrefixNotConfiguredFault)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

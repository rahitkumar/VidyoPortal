...
public class NotLicensedFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137541L;
    
    private com.vidyo.portal.user.v1_1.NotLicensedFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.NotLicensedFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.NotLicensedFault getFaultMessage(){
       return faultMessage;
    }
}

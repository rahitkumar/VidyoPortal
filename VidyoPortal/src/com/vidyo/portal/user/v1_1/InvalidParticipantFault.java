 ...
 */
            ...
            /**
            *  InvalidParticipantFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InvalidParticipantFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InvalidParticipantFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "InvalidParticipantFault",
    ...
    public static class Factory{
        ...
        */
        public static InvalidParticipantFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InvalidParticipantFault object =
                new InvalidParticipantFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InvalidParticipantFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InvalidParticipantFault)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

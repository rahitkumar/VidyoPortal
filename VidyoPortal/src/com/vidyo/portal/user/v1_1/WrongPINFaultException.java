...
public class WrongPINFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137526L;
    
    private com.vidyo.portal.user.v1_1.WrongPINFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.WrongPINFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.WrongPINFault getFaultMessage(){
       return faultMessage;
    }
}

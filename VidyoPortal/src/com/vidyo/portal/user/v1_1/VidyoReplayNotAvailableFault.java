...
/**
 * VidyoReplayNotAvailableFault.java
 *
 ...
 */
            ...
            /**
            *  VidyoReplayNotAvailableFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class VidyoReplayNotAvailableFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VidyoReplayNotAvailableFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VidyoReplayNotAvailableFault",
    ...
    public static class Factory{
        ...
        */
        public static VidyoReplayNotAvailableFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VidyoReplayNotAvailableFault object =
                new VidyoReplayNotAvailableFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VidyoReplayNotAvailableFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VidyoReplayNotAvailableFault)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

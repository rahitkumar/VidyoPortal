...
/**
 * MuteVideoClientAllRequest.java
 *
 ...
 */
            ...
            /**
            *  MuteVideoClientAllRequest bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":muteVideoClientAllRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "muteVideoClientAllRequest",
    ...
    public static class Factory{
        ...
        */
        public static MuteVideoClientAllRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MuteVideoClientAllRequest object =
                new MuteVideoClientAllRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"muteVideoClientAllRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MuteVideoClientAllRequest)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
/**
 * DisconnectConferenceAllRequest.java
 *
 ...
 */
            ...
            /**
            *  DisconnectConferenceAllRequest bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":disconnectConferenceAllRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "disconnectConferenceAllRequest",
    ...
    public static class Factory{
        ...
        */
        public static DisconnectConferenceAllRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DisconnectConferenceAllRequest object =
                new DisconnectConferenceAllRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"disconnectConferenceAllRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DisconnectConferenceAllRequest)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
/**
 * GetActiveSessionsResponse.java
 *
 ...
 */
            ...
            /**
            *  GetActiveSessionsResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetActiveSessionsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetActiveSessionsResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetActiveSessionsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetActiveSessionsResponse object =
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetActiveSessionsResponse".equals(type)){
                                ...
                                return (GetActiveSessionsResponse)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","count").equals(reader.getName())){

...
public class RoomNotFoundFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137509L;
    
    private com.vidyo.portal.user.v1_1.RoomNotFoundFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.RoomNotFoundFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.RoomNotFoundFault getFaultMessage(){
       return faultMessage;
    }
}

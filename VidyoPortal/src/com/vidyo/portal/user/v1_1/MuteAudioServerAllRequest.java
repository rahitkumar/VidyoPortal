...
/**
 * MuteAudioServerAllRequest.java
 *
 ...
 */
            ...
            /**
            *  MuteAudioServerAllRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class MuteAudioServerAllRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/user/v1_1",
                "muteAudioServerAllRequest",
                "ns1");
                        ...
                        */
                                    ...
                                    protected boolean localMuteState ;
                           ...
                           */
                           public  boolean getMuteState(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MuteState
                               */
                               public void setMuteState(boolean param){
                            
                                            this.localMuteState=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":muteAudioServerAllRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "muteAudioServerAllRequest",
                           xmlWriter);
                                    ...
                                    writeStartElement(null, namespace, "muteState", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("muteState cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMuteState));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMuteState));
                             if (localModeratorPINTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1",
                                                                      "moderatorPIN"));
    ...
    public static class Factory{
        ...
        */
        public static MuteAudioServerAllRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MuteAudioServerAllRequest object =
                new MuteAudioServerAllRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"muteAudioServerAllRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MuteAudioServerAllRequest)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","muteState").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"muteState" +"  cannot be null");
                                    }

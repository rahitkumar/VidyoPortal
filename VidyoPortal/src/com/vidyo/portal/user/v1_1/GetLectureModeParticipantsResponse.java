        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[] localLectureModeParticipant ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[]
                           */
                           public  com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[] getLectureModeParticipant(){
                               ...
                               */
                              protected void validateLectureModeParticipant(com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[] param){
                              ...
                              */
                              public void setLectureModeParticipant(com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[] param){
                             ...
                             * @param param com.vidyo.portal.user.v1_1.LectureModeParticipant_type0
                             */
                             public void addLectureModeParticipant(com.vidyo.portal.user.v1_1.LectureModeParticipant_type0 param){
                                   if (localLectureModeParticipant == null){
                                   localLectureModeParticipant = new com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localLectureModeParticipant);
                             ...
                             (com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[])list.toArray(
                            new com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[list.size()]);
                                       ...
                                       if (localLectureModeParticipant!=null){
                                            for (int i = 0;i < localLectureModeParticipant.length;i++){
                                                if (localLectureModeParticipant[i] != null){
                                                 localLectureModeParticipant[i].serialize(new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","LectureModeParticipant"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetLectureModeParticipantsResponse".equals(type)){
                                ...
                                return (GetLectureModeParticipantsResponse)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list7 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","lectureMode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","LectureModeParticipant").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list7.add(com.vidyo.portal.user.v1_1.LectureModeParticipant_type0.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone7){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","LectureModeParticipant").equals(reader.getName())){
                                                                    list7.add(com.vidyo.portal.user.v1_1.LectureModeParticipant_type0.Factory.parse(reader));
                                                        ...
                                                        object.setLectureModeParticipant((com.vidyo.portal.user.v1_1.LectureModeParticipant_type0[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.vidyo.portal.user.v1_1.LectureModeParticipant_type0.class,
                                                                list7));

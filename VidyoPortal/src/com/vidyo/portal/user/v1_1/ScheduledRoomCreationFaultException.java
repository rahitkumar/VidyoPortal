...
public class ScheduledRoomCreationFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137475L;
    
    private com.vidyo.portal.user.v1_1.ScheduledRoomCreationFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.ScheduledRoomCreationFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.ScheduledRoomCreationFault getFaultMessage(){
       return faultMessage;
    }
}

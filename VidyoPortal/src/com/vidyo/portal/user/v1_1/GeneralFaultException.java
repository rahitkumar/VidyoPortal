...
public class GeneralFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137493L;
    
    private com.vidyo.portal.user.v1_1.GeneralFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.GeneralFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.GeneralFault getFaultMessage(){
       return faultMessage;
    }
}

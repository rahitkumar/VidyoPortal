...
/**
 * NotAllowedThumbnailPhotoFault.java
 *
 ...
 */
            ...
            /**
            *  NotAllowedThumbnailPhotoFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NotAllowedThumbnailPhotoFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/user/v1_1",
                "NotAllowedThumbnailPhotoFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NotAllowedThumbnailPhotoFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NotAllowedThumbnailPhotoFault",
    ...
    public static class Factory{
        ...
        */
        public static NotAllowedThumbnailPhotoFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NotAllowedThumbnailPhotoFault object =
                new NotAllowedThumbnailPhotoFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NotAllowedThumbnailPhotoFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NotAllowedThumbnailPhotoFault)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

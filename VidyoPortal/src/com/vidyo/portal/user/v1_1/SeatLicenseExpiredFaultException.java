...
public class SeatLicenseExpiredFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137472L;
    
    private com.vidyo.portal.user.v1_1.SeatLicenseExpiredFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.SeatLicenseExpiredFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.SeatLicenseExpiredFault getFaultMessage(){
       return faultMessage;
    }
}

...
public class AccessRestrictedFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137519L;
    
    private com.vidyo.portal.user.v1_1.AccessRestrictedFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.AccessRestrictedFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.AccessRestrictedFault getFaultMessage(){
       return faultMessage;
    }
}

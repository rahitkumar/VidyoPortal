...
public class ConferenceLockedFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1504103137512L;
    
    private com.vidyo.portal.user.v1_1.ConferenceLockedFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.v1_1.ConferenceLockedFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.v1_1.ConferenceLockedFault getFaultMessage(){
       return faultMessage;
    }
}

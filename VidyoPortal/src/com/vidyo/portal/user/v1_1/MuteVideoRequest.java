 ...
 */
            ...
            /**
            *  MuteVideoRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class MuteVideoRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MuteVideoRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MuteVideoRequest",
    ...
    public static class Factory{
        ...
        */
        public static MuteVideoRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MuteVideoRequest object =
                new MuteVideoRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MuteVideoRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MuteVideoRequest)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  SilenceSpeakerServerType bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for SilenceState
                        */

                        
                                    protected com.vidyo.portal.user.v1_1.SilenceState localSilenceState ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.vidyo.portal.user.v1_1.SilenceState
                           */
                           public  com.vidyo.portal.user.v1_1.SilenceState getSilenceState(){
                               return localSilenceState;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param SilenceState
                               */
                               public void setSilenceState(com.vidyo.portal.user.v1_1.SilenceState param){
                            
                                            this.localSilenceState=param;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String getModeratorPIN(){
                            ...
                            localModeratorPINTracker = param != null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SilenceSpeakerServerType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SilenceSpeakerServerType",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                                            ...
                                            if (localSilenceState==null){
                                                 throw new org.apache.axis2.databinding.ADBException("silenceState cannot be null!!");
                                            }
                                           localSilenceState.serialize(new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","silenceState"),
                                               xmlWriter);
                                    ...
                                    writeStartElement(null, namespace, "moderatorPIN", xmlWriter);
                                          ...
                                          if (localModeratorPIN==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("moderatorPIN cannot be null!!");
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1",
                                    ...
                                    elementList.add(localSilenceState);
                                 if (localModeratorPINTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1",
                                                                      "moderatorPIN"));
                                 
                                        if (localModeratorPIN != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localModeratorPIN));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("moderatorPIN cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static SilenceSpeakerServerType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SilenceSpeakerServerType object =
                new SilenceSpeakerServerType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SilenceSpeakerServerType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SilenceSpeakerServerType)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/user/v1_1","silenceState").equals(reader.getName())){
                                
                                                object.setSilenceState(com.vidyo.portal.user.v1_1.SilenceState.Factory.parse(reader));
                                    ...
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"moderatorPIN" +"  cannot be null");
                                    }

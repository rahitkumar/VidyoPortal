 ...
 */
            ...
            /**
            *  FeatureNotAvailableFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FeatureNotAvailableFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/user/v1_1",
                "FeatureNotAvailableFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FeatureNotAvailableFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FeatureNotAvailableFault",
    ...
    public static class Factory{
        ...
        */
        public static FeatureNotAvailableFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FeatureNotAvailableFault object =
                new FeatureNotAvailableFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FeatureNotAvailableFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FeatureNotAvailableFault)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

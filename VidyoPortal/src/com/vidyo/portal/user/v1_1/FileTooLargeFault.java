 ...
 */
            ...
            /**
            *  FileTooLargeFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FileTooLargeFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FileTooLargeFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FileTooLargeFault",
    ...
    public static class Factory{
        ...
        */
        public static FileTooLargeFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FileTooLargeFault object =
                new FileTooLargeFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FileTooLargeFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FileTooLargeFault)com.vidyo.portal.user.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

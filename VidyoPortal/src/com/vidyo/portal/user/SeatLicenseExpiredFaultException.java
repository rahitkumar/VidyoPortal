...
public class SeatLicenseExpiredFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1358373547518L;
    
    private com.vidyo.portal.user.SeatLicenseExpiredFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.user.SeatLicenseExpiredFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.user.SeatLicenseExpiredFault getFaultMessage(){
       return faultMessage;
    }
}

 ...
 */
            ...
            /**
            *  RoomNotFoundFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RoomNotFoundFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RoomNotFoundFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RoomNotFoundFault",
    ...
    public static class Factory{
        ...
        */
        public static RoomNotFoundFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RoomNotFoundFault object =
                new RoomNotFoundFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RoomNotFoundFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RoomNotFoundFault)com.vidyo.portal.admin.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

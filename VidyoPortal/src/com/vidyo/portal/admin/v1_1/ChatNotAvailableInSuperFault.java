...
/**
 * ChatNotAvailableInSuperFault.java
 *
 ...
 */
            ...
            /**
            *  ChatNotAvailableInSuperFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ChatNotAvailableInSuperFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ChatNotAvailableInSuperFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ChatNotAvailableInSuperFault",
    ...
    public static class Factory{
        ...
        */
        public static ChatNotAvailableInSuperFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ChatNotAvailableInSuperFault object =
                new ChatNotAvailableInSuperFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ChatNotAvailableInSuperFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ChatNotAvailableInSuperFault)com.vidyo.portal.admin.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
public class ResourceNotAvailableFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1497867977647L;
    
    private com.vidyo.portal.admin.v1_1.ResourceNotAvailableFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.portal.admin.v1_1.ResourceNotAvailableFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.portal.admin.v1_1.ResourceNotAvailableFault getFaultMessage(){
       return faultMessage;
    }
}

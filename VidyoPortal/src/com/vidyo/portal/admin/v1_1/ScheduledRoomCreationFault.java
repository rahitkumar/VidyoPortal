...
/**
 * ScheduledRoomCreationFault.java
 *
 ...
 */
            ...
            /**
            *  ScheduledRoomCreationFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ScheduledRoomCreationFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/admin/v1_1",
                "ScheduledRoomCreationFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ScheduledRoomCreationFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ScheduledRoomCreationFault",
    ...
    public static class Factory{
        ...
        */
        public static ScheduledRoomCreationFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ScheduledRoomCreationFault object =
                new ScheduledRoomCreationFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ScheduledRoomCreationFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ScheduledRoomCreationFault)com.vidyo.portal.admin.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

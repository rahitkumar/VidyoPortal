...
/**
 * ScheduledRoomIsEnabledResponse.java
 *
 ...
 */
            ...
            /**
            *  ScheduledRoomIsEnabledResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ScheduledRoomIsEnabledResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/admin/v1_1",
                "ScheduledRoomIsEnabledResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ScheduledRoomIsEnabledResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ScheduledRoomIsEnabledResponse",
    ...
    public static class Factory{
        ...
        */
        public static ScheduledRoomIsEnabledResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ScheduledRoomIsEnabledResponse object =
                new ScheduledRoomIsEnabledResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ScheduledRoomIsEnabledResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ScheduledRoomIsEnabledResponse)com.vidyo.portal.admin.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
/**
 * NoEndpointBehaviorExistsFault.java
 *
 ...
 */
            ...
            /**
            *  NoEndpointBehaviorExistsFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NoEndpointBehaviorExistsFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NoEndpointBehaviorExistsFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NoEndpointBehaviorExistsFault",
    ...
    public static class Factory{
        ...
        */
        public static NoEndpointBehaviorExistsFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NoEndpointBehaviorExistsFault object =
                new NoEndpointBehaviorExistsFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NoEndpointBehaviorExistsFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NoEndpointBehaviorExistsFault)com.vidyo.portal.admin.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

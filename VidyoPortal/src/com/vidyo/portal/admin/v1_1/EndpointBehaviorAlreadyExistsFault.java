...
/**
 * EndpointBehaviorAlreadyExistsFault.java
 *
 ...
 */
            ...
            /**
            *  EndpointBehaviorAlreadyExistsFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EndpointBehaviorAlreadyExistsFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/admin/v1_1",
                "EndpointBehaviorAlreadyExistsFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EndpointBehaviorAlreadyExistsFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EndpointBehaviorAlreadyExistsFault",
    ...
    public static class Factory{
        ...
        */
        public static EndpointBehaviorAlreadyExistsFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EndpointBehaviorAlreadyExistsFault object =
                new EndpointBehaviorAlreadyExistsFault();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EndpointBehaviorAlreadyExistsFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EndpointBehaviorAlreadyExistsFault)com.vidyo.portal.admin.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1","ErrorMessage").equals(reader.getName())){

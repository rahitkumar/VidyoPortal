        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for RoomDetail
                        * This was an Array!
                        */

                        
                                    protected com.vidyo.portal.admin.v1_1.RoomDetail_type0[] localRoomDetail ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRoomDetailTracker = false ;

                           public boolean isRoomDetailSpecified(){
                               return localRoomDetailTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.vidyo.portal.admin.v1_1.RoomDetail_type0[]
                           */
                           public  com.vidyo.portal.admin.v1_1.RoomDetail_type0[] getRoomDetail(){
                               return localRoomDetail;
                           }
                              ...
                              /**
                               * validate the array for RoomDetail
                               */
                              protected void validateRoomDetail(com.vidyo.portal.admin.v1_1.RoomDetail_type0[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param RoomDetail
                              */
                              public void setRoomDetail(com.vidyo.portal.admin.v1_1.RoomDetail_type0[] param){
                              
                                   validateRoomDetail(param);

                               localRoomDetailTracker = param != null;
                                      
                                      this.localRoomDetail=param;
                              }
                             ...
                             * @param param com.vidyo.portal.admin.v1_1.RoomDetail_type0
                             */
                             public void addRoomDetail(com.vidyo.portal.admin.v1_1.RoomDetail_type0 param){
                                   if (localRoomDetail == null){
                                   localRoomDetail = new com.vidyo.portal.admin.v1_1.RoomDetail_type0[]{};
                                   }

                            
                                 //update the setting tracker
                                localRoomDetailTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localRoomDetail);
                               list.add(param);
                               this.localRoomDetail =
                             (com.vidyo.portal.admin.v1_1.RoomDetail_type0[])list.toArray(
                            new com.vidyo.portal.admin.v1_1.RoomDetail_type0[list.size()]);
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                              if (localRoomDetailTracker){
                                       if (localRoomDetail!=null){
                                            for (int i = 0;i < localRoomDetail.length;i++){
                                                if (localRoomDetail[i] != null){
                                                 localRoomDetail[i].serialize(new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1","RoomDetail"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("RoomDetail cannot be null!!");
                             ...
                             if (localRoomDetail!=null) {
                                 for (int i = 0;i < localRoomDetail.length;i++){
                                    ...
                                    if (localRoomDetail[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1",
                                                                          "RoomDetail"));
                                         elementList.add(localRoomDetail[i]);
                                    } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SearchRoomsResponse".equals(type)){
                                ...
                                return (SearchRoomsResponse)com.vidyo.portal.admin.v1_1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list9 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1","query").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1","queryField").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1","roomType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1","RoomDetail").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list9.add(com.vidyo.portal.admin.v1_1.RoomDetail_type0.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone9){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://portal.vidyo.com/admin/v1_1","RoomDetail").equals(reader.getName())){
                                                                    list9.add(com.vidyo.portal.admin.v1_1.RoomDetail_type0.Factory.parse(reader));
                                                        ...
                                                        object.setRoomDetail((com.vidyo.portal.admin.v1_1.RoomDetail_type0[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.vidyo.portal.admin.v1_1.RoomDetail_type0.class,
                                                                list9));

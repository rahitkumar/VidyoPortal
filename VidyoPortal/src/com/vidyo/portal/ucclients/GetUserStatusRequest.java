...
public class GetUserStatusRequest implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "GetUserStatusRequest", "ns4");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetUserStatusRequest", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetUserStatusRequest", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetUserStatusRequest parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetUserStatusRequest object = new GetUserStatusRequest();
						...
						if (!"GetUserStatusRequest".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetUserStatusRequest) com.vidyo.portal.ucclients.ExtensionMapper

...
public class JoinConferenceRequest implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "JoinConferenceRequest", "ns4");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":JoinConferenceRequest", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"JoinConferenceRequest", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static JoinConferenceRequest parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			JoinConferenceRequest object = new JoinConferenceRequest();
						...
						if (!"JoinConferenceRequest".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (JoinConferenceRequest) com.vidyo.portal.ucclients.ExtensionMapper

...
public class NotLicensedFault implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "NotLicensedFault", "ns4");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":NotLicensedFault", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"NotLicensedFault", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NotLicensedFault parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			NotLicensedFault object = new NotLicensedFault();
						...
						if (!"NotLicensedFault".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NotLicensedFault) com.vidyo.portal.ucclients.ExtensionMapper

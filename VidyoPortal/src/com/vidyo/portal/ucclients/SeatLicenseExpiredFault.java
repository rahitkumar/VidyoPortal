...
public class SeatLicenseExpiredFault implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "SeatLicenseExpiredFault",
			"ns4");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SeatLicenseExpiredFault", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SeatLicenseExpiredFault", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://portal.vidyo.com/ucclients", "ErrorMessage"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SeatLicenseExpiredFault parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			SeatLicenseExpiredFault object = new SeatLicenseExpiredFault();
						...
						if (!"SeatLicenseExpiredFault".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (SeatLicenseExpiredFault) com.vidyo.portal.ucclients.ExtensionMapper

...
public class RoomDisabledFault implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "RoomDisabledFault", "ns4");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":RoomDisabledFault", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"RoomDisabledFault", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RoomDisabledFault parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RoomDisabledFault object = new RoomDisabledFault();
						...
						if (!"RoomDisabledFault".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (RoomDisabledFault) com.vidyo.portal.ucclients.ExtensionMapper

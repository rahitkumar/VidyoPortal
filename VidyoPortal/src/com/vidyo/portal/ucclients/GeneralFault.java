...
public class GeneralFault implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "GeneralFault", "ns4");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GeneralFault", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GeneralFault", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GeneralFault parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GeneralFault object = new GeneralFault();
						...
						if (!"GeneralFault".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GeneralFault) com.vidyo.portal.ucclients.ExtensionMapper

...
public class InvalidArgumentFault implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "InvalidArgumentFault", "ns4");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":InvalidArgumentFault", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"InvalidArgumentFault", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static InvalidArgumentFault parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			InvalidArgumentFault object = new InvalidArgumentFault();
						...
						if (!"InvalidArgumentFault".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (InvalidArgumentFault) com.vidyo.portal.ucclients.ExtensionMapper

...
public class InviteToConferenceRequest implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "InviteToConferenceRequest",
			"ns4");
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"InviteToConferenceRequest", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static InviteToConferenceRequest parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			InviteToConferenceRequest object = new InviteToConferenceRequest();
						...
						if (!"InviteToConferenceRequest".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (InviteToConferenceRequest) com.vidyo.portal.ucclients.ExtensionMapper

...
public class RoomMode implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://portal.vidyo.com/ucclients", "RoomMode", "ns4");
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RoomMode parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			RoomMode object = new RoomMode();
					...
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName(
										...
										"RoomMode").equals(reader.getName())) {

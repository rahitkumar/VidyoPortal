...
public class UserStatus_type0 implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * UserStatus_type0 Namespace URI = http://portal.vidyo.com/ucclients
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":UserStatus_type0", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"UserStatus_type0", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://portal.vidyo.com/ucclients", "username"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UserStatus_type0 parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			UserStatus_type0 object = new UserStatus_type0();
						...
						if (!"UserStatus_type0".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (UserStatus_type0) com.vidyo.portal.ucclients.ExtensionMapper

...
/**
 * EmailAddressNotFoundFault.java
 *
 ...
 */
            ...
            /**
            *  EmailAddressNotFoundFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EmailAddressNotFoundFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/guest",
                "EmailAddressNotFoundFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EmailAddressNotFoundFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EmailAddressNotFoundFault",
    ...
    public static class Factory{
        ...
        */
        public static EmailAddressNotFoundFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EmailAddressNotFoundFault object =
                new EmailAddressNotFoundFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EmailAddressNotFoundFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EmailAddressNotFoundFault)com.vidyo.portal.guest.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  AllLinesInUseFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AllLinesInUseFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AllLinesInUseFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AllLinesInUseFault",
    ...
    public static class Factory{
        ...
        */
        public static AllLinesInUseFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AllLinesInUseFault object =
                new AllLinesInUseFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AllLinesInUseFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AllLinesInUseFault)com.vidyo.portal.guest.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  RoomIsFullFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RoomIsFullFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RoomIsFullFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RoomIsFullFault",
    ...
    public static class Factory{
        ...
        */
        public static RoomIsFullFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RoomIsFullFault object =
                new RoomIsFullFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RoomIsFullFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RoomIsFullFault)com.vidyo.portal.guest.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

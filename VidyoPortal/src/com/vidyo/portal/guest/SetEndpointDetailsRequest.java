        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected com.vidyo.portal.guest.EndpointFeature_type0[] localEndpointFeature ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localEndpointFeatureTracker = false ;

                           public boolean isEndpointFeatureSpecified(){
                               return localEndpointFeatureTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.vidyo.portal.guest.EndpointFeature_type0[]
                           */
                           public  com.vidyo.portal.guest.EndpointFeature_type0[] getEndpointFeature(){
                               ...
                               */
                              protected void validateEndpointFeature(com.vidyo.portal.guest.EndpointFeature_type0[] param){
                              ...
                              */
                              public void setEndpointFeature(com.vidyo.portal.guest.EndpointFeature_type0[] param){
                              
                                   validateEndpointFeature(param);

                               localEndpointFeatureTracker = param != null;
                             ...
                             * @param param com.vidyo.portal.guest.EndpointFeature_type0
                             */
                             public void addEndpointFeature(com.vidyo.portal.guest.EndpointFeature_type0 param){
                                   if (localEndpointFeature == null){
                                   localEndpointFeature = new com.vidyo.portal.guest.EndpointFeature_type0[]{};
                                   }

                            
                                 //update the setting tracker
                                localEndpointFeatureTracker = true;
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localEndpointFeature);
                             ...
                             (com.vidyo.portal.guest.EndpointFeature_type0[])list.toArray(
                            new com.vidyo.portal.guest.EndpointFeature_type0[list.size()]);
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                              if (localEndpointFeatureTracker){
                                       if (localEndpointFeature!=null){
                                            for (int i = 0;i < localEndpointFeature.length;i++){
                                                if (localEndpointFeature[i] != null){
                                                 localEndpointFeature[i].serialize(new javax.xml.namespace.QName("http://portal.vidyo.com/guest","EndpointFeature"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SetEndpointDetailsRequest".equals(type)){
                                ...
                                return (SetEndpointDetailsRequest)com.vidyo.portal.guest.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://portal.vidyo.com/guest","EndpointFeature").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(com.vidyo.portal.guest.EndpointFeature_type0.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://portal.vidyo.com/guest","EndpointFeature").equals(reader.getName())){
                                                                    list3.add(com.vidyo.portal.guest.EndpointFeature_type0.Factory.parse(reader));
                                                        ...
                                                        object.setEndpointFeature((com.vidyo.portal.guest.EndpointFeature_type0[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.vidyo.portal.guest.EndpointFeature_type0.class,
                                                                list3));

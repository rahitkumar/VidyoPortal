...
/**
 * SetMobileLoginModeRequest.java
 *
 ...
 */
            ...
            /**
            *  SetMobileLoginModeRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetMobileLoginModeRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://portal.vidyo.com/superapi/",
                "setMobileLoginModeRequest",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setMobileLoginModeRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setMobileLoginModeRequest",
    ...
    public static class Factory{
        ...
        */
        public static SetMobileLoginModeRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetMobileLoginModeRequest object =
                new SetMobileLoginModeRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setMobileLoginModeRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetMobileLoginModeRequest)com.vidyo.portal.superapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

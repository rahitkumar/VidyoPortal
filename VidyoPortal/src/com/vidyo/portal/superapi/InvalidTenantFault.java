 ...
 */
            ...
            /**
            *  InvalidTenantFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InvalidTenantFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InvalidTenantFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "InvalidTenantFault",
    ...
    public static class Factory{
        ...
        */
        public static InvalidTenantFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InvalidTenantFault object =
                new InvalidTenantFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InvalidTenantFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InvalidTenantFault)com.vidyo.portal.superapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

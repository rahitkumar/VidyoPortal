 ...
 */
            ...
            /**
            *  ExistingTenantFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ExistingTenantFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ExistingTenantFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ExistingTenantFault",
    ...
    public static class Factory{
        ...
        */
        public static ExistingTenantFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExistingTenantFault object =
                new ExistingTenantFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ExistingTenantFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ExistingTenantFault)com.vidyo.portal.superapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

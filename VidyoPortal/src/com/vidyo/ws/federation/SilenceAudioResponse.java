 ...
 */
            ...
            /**
            *  SilenceAudioResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SilenceAudioResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.vidyo.com/federation",
                "SilenceAudioResponse",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SilenceAudioResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SilenceAudioResponse",
    ...
    public static class Factory{
        ...
        */
        public static SilenceAudioResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SilenceAudioResponse object =
                new SilenceAudioResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SilenceAudioResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SilenceAudioResponse)com.vidyo.ws.federation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

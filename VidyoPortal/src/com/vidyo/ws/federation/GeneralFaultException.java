...
public class GeneralFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1364507615986L;
    
    private com.vidyo.ws.federation.GeneralFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.ws.federation.GeneralFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.ws.federation.GeneralFault getFaultMessage(){
       return faultMessage;
    }
}

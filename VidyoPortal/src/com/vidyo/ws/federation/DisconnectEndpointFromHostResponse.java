...
/**
 * DisconnectEndpointFromHostResponse.java
 *
 ...
 */
            ...
            /**
            *  DisconnectEndpointFromHostResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DisconnectEndpointFromHostResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.vidyo.com/federation",
                "DisconnectEndpointFromHostResponse",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DisconnectEndpointFromHostResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DisconnectEndpointFromHostResponse",
    ...
    public static class Factory{
        ...
        */
        public static DisconnectEndpointFromHostResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DisconnectEndpointFromHostResponse object =
                new DisconnectEndpointFromHostResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DisconnectEndpointFromHostResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DisconnectEndpointFromHostResponse)com.vidyo.ws.federation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

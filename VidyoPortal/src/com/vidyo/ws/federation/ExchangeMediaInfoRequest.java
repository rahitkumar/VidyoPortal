 ...
 */
            ...
            /**
            *  ExchangeMediaInfoRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ExchangeMediaInfoRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.vidyo.com/federation",
                "ExchangeMediaInfoRequest",
                "ns2");
                        ...
                        */
                        ...
                        /**
                        * field for MediaAddress
                        */

                        
                                    protected java.lang.String localMediaAddress ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getMediaAddress(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MediaAddress
                               */
                               public void setMediaAddress(java.lang.String param){
                            
                                            this.localMediaAddress=param;
                        ...
                        /**
                        * field for MediaAdditionalInfo
                        */

                        
                                    protected java.lang.String localMediaAdditionalInfo ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getMediaAdditionalInfo(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MediaAdditionalInfo
                               */
                               public void setMediaAdditionalInfo(java.lang.String param){
                            
                                            this.localMediaAdditionalInfo=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ExchangeMediaInfoRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ExchangeMediaInfoRequest",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://ws.vidyo.com/federation";
                                    writeStartElement(null, namespace, "MediaAddress", xmlWriter);
                             

                                          if (localMediaAddress==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("MediaAddress cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localMediaAddress);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://ws.vidyo.com/federation";
                                    writeStartElement(null, namespace, "MediaAdditionalInfo", xmlWriter);
                             

                                          if (localMediaAdditionalInfo==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("MediaAdditionalInfo cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localMediaAdditionalInfo);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.vidyo.com/federation",
                                        ...
                                        if (localMediaAddress != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMediaAddress));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("MediaAddress cannot be null!!");
                                        }
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.vidyo.com/federation",
                                        ...
                                        if (localMediaAdditionalInfo != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMediaAdditionalInfo));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("MediaAdditionalInfo cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static ExchangeMediaInfoRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExchangeMediaInfoRequest object =
                new ExchangeMediaInfoRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ExchangeMediaInfoRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ExchangeMediaInfoRequest)com.vidyo.ws.federation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.vidyo.com/federation","MediaAddress").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"MediaAddress" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMediaAddress(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.vidyo.com/federation","MediaAdditionalInfo").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"MediaAdditionalInfo" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMediaAdditionalInfo(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));

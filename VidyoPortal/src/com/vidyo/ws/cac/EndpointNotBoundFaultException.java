...
public class EndpointNotBoundFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1470968343866L;
    
    private com.vidyo.ws.cac.EndpointNotBoundFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.ws.cac.EndpointNotBoundFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.ws.cac.EndpointNotBoundFault getFaultMessage(){
       return faultMessage;
    }
}

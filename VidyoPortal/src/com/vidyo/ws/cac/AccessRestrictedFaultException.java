...
public class AccessRestrictedFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1470968343984L;
    
    private com.vidyo.ws.cac.AccessRestrictedFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.ws.cac.AccessRestrictedFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.ws.cac.AccessRestrictedFault getFaultMessage(){
       return faultMessage;
    }
}

...
public class InvalidArgumentFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1470968343827L;
    
    private com.vidyo.ws.cac.InvalidArgumentFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.ws.cac.InvalidArgumentFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.ws.cac.InvalidArgumentFault getFaultMessage(){
       return faultMessage;
    }
}

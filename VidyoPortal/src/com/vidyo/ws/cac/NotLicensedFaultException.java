...
public class NotLicensedFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1470968344054L;
    
    private com.vidyo.ws.cac.NotLicensedFault faultMessage;
    ...
    public void setFaultMessage(com.vidyo.ws.cac.NotLicensedFault msg){
       faultMessage = msg;
    }
    
    public com.vidyo.ws.cac.NotLicensedFault getFaultMessage(){
       return faultMessage;
    }
}

...
/**
 * ConnectExternalLinkRequest.java
 *
 ...
 */
            ...
            /**
            *  ConnectExternalLinkRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ConnectExternalLinkRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.vidyo.com/manager",
                "ConnectExternalLinkRequest",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ConnectExternalLinkRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ConnectExternalLinkRequest",
    ...
    public static class Factory{
        ...
        */
        public static ConnectExternalLinkRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConnectExternalLinkRequest object =
                new ConnectExternalLinkRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ConnectExternalLinkRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConnectExternalLinkRequest)com.vidyo.ws.manager.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

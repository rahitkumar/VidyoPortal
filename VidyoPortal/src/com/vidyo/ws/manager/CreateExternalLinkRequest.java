 ...
 */
            ...
            /**
            *  CreateExternalLinkRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for RouterPool
                        */

                        
                                    protected java.lang.String localRouterPool ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRouterPoolTracker = false ;

                           public boolean isRouterPoolSpecified(){
                               return localRouterPoolTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getRouterPool(){
                               return localRouterPool;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RouterPool
                               */
                               public void setRouterPool(java.lang.String param){
                            localRouterPoolTracker = param != null;
                                   
                                            this.localRouterPool=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreateExternalLinkRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreateExternalLinkRequest",
                           xmlWriter);
                              ...
                              if (localRemoteMediaAddressTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localRouterPoolTracker){
                                    namespace = "http://ws.vidyo.com/manager";
                                    writeStartElement(null, namespace, "RouterPool", xmlWriter);
                             

                                          if (localRouterPool==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("RouterPool cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localRouterPool);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                     ...
                                     if (localRemoteMediaAddressTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.vidyo.com/manager",
                                        ...
                                        if (localRouterPool != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRouterPool));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("RouterPool cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static CreateExternalLinkRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateExternalLinkRequest object =
                new CreateExternalLinkRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreateExternalLinkRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateExternalLinkRequest)com.vidyo.ws.manager.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.vidyo.com/manager","RouterPool").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"RouterPool" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setRouterPool(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));

 ...
 */
            ...
            /**
            *  NEGroupType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NEGroupType
    ...
    public static class Factory{
        ...
        */
        public static NEGroupType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NEGroupType object =
                new NEGroupType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NEGroupType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NEGroupType)com.vidyo.ws.manager.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.vidyo.com/manager","GroupName").equals(reader.getName())){

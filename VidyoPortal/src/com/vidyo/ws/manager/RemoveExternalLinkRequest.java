...
/**
 * RemoveExternalLinkRequest.java
 *
 ...
 */
            ...
            /**
            *  RemoveExternalLinkRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveExternalLinkRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RemoveExternalLinkRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RemoveExternalLinkRequest",
    ...
    public static class Factory{
        ...
        */
        public static RemoveExternalLinkRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveExternalLinkRequest object =
                new RemoveExternalLinkRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RemoveExternalLinkRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveExternalLinkRequest)com.vidyo.ws.manager.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

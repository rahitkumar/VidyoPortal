 ...
 */
            ...
            /**
            *  RemoveEndpointRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveEndpointRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RemoveEndpointRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RemoveEndpointRequest",
    ...
    public static class Factory{
        ...
        */
        public static RemoveEndpointRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveEndpointRequest object =
                new RemoveEndpointRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RemoveEndpointRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveEndpointRequest)com.vidyo.ws.manager.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  NotSupportedFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NotSupportedFault
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NotSupportedFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NotSupportedFault",
    ...
    public static class Factory{
        ...
        */
        public static NotSupportedFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NotSupportedFault object =
                new NotSupportedFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NotSupportedFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NotSupportedFault)com.vidyo.ws.configuration.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

...
/**
 * UpdateRouterEndpointStatusRequest.java
 *
 ...
 */
            ...
            /**
            *  UpdateRouterEndpointStatusRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateRouterEndpointStatusRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.vidyo.com/portal",
                "UpdateRouterEndpointStatusRequest",
                "ns1");
                           ...
                           */
                           public  boolean getJoined(){
                            ...
                            /**
                               ...
                               * @param param Joined
                               */
                               public void setJoined(boolean param){
                            
                                            this.localJoined=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateRouterEndpointStatusRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateRouterEndpointStatusRequest",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://ws.vidyo.com/portal";
                                    writeStartElement(null, namespace, "Joined", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("Joined cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localJoined));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://ws.vidyo.com/portal",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localJoined));
                             if (localSequenceNumTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://ws.vidyo.com/portal",
                                                                      "SequenceNum"));
    ...
    public static class Factory{
        ...
        */
        public static UpdateRouterEndpointStatusRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateRouterEndpointStatusRequest object =
                new UpdateRouterEndpointStatusRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateRouterEndpointStatusRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateRouterEndpointStatusRequest)com.vidyo.ws.portal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.vidyo.com/portal","Joined").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"Joined" +"  cannot be null");
                                    }
